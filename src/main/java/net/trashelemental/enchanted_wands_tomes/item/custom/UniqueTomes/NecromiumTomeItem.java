...
public class NecromiumTomeItem extends TomeItem {
    public NecromiumTomeItem(Properties properties, int baseCooldown, int enchantmentValue, int maxEnchantments) {
