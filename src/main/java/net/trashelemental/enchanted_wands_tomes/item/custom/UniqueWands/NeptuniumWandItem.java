...
public class NeptuniumWandItem extends WandItem {
    public NeptuniumWandItem(Properties properties, int baseDamage, int baseCooldown, int maxEnchantments, int enchantmentValue) {
