...
public class FieryWandItem extends WandItem {
    public FieryWandItem(Properties properties, int baseDamage, int baseCooldown, int maxEnchantments, int enchantmentValue) {
