...
public class DracoArcanusTomeItem extends TomeItem {
    public DracoArcanusTomeItem(Properties properties, int baseCooldown, int enchantmentValue, int maxEnchantments) {
