...
public class HoneyCrystalTomeItem extends TomeItem {
    public HoneyCrystalTomeItem(Properties properties, int baseCooldown, int enchantmentValue, int maxEnchantments) {
