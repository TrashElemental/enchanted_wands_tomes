...
public class HoneyCrystalWandItem extends WandItem {
    public HoneyCrystalWandItem(Properties properties, int baseDamage, int baseCooldown, int maxEnchantments, int enchantmentValue) {
