...
public class GravititeWandItem extends WandItem {
    public GravititeWandItem(Properties properties, int baseDamage, int baseCooldown, int maxEnchantments, int enchantmentValue) {
