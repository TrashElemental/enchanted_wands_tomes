...
public class NecromiumWandItem extends WandItem {
    public NecromiumWandItem(Properties properties, int baseDamage, int baseCooldown, int maxEnchantments, int enchantmentValue) {
