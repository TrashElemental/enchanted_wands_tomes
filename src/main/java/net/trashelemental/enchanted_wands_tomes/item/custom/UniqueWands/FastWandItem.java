...
public class FastWandItem extends WandItem {
    public FastWandItem(Properties properties, int baseDamage, int baseCooldown, int maxEnchantments, int enchantmentValue) {
