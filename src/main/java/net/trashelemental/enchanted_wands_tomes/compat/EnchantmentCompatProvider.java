...
public class EnchantmentCompatProvider extends TagsProvider<Enchantment> {
    ...
    public EnchantmentCompatProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider, String modId, @Nullable ExistingFileHelper existingFileHelper) {
        super(output, ResourceKey.createRegistryKey(Registries.ENCHANTMENT.location()), lookupProvider, CompletableFuture.completedFuture(TagsProvider.TagLookup.empty()), modId, existingFileHelper);
    }
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        //Apotheosis
        addEnchantmentToTag("apothic_enchanting:bane_of_illagers", ModTags.Enchantments.WAND_SMITE);
        addEnchantmentToTag("apothic_enchanting:bane_of_illagers", ModTags.Enchantments.TOME_DEBUFF);
        addEnchantmentToTag("apothic_enchanting:berserkers_fury", ModTags.Enchantments.WAND_DAMAGE);
        addEnchantmentToTag("apothic_enchanting:berserkers_fury", ModTags.Enchantments.TOME_AOE);
        addEnchantmentToTag("apothic_enchanting:capturing", ModTags.Enchantments.LUCK);
        addEnchantmentToTag("apothic_enchanting:chainsaw", ModTags.Enchantments.COOLDOWN_REDUCE);
        addEnchantmentToTag("apothic_enchanting:chromatic", ModTags.Enchantments.LUCK);
        addEnchantmentToTag("apothic_enchanting:crescendo_of_bolts", ModTags.Enchantments.MULTISHOT);
        addEnchantmentToTag("apothic_enchanting:boon_of_the_earth", ModTags.Enchantments.LUCK);
        addEnchantmentToTag("apothic_enchanting:endless_quiver", ModTags.Enchantments.MULTISHOT);
        addEnchantmentToTag("apothic_enchanting:worker_exploitation", ModTags.Enchantments.LUCK);
        addEnchantmentToTag("apothic_enchanting:growth_serum", ModTags.Enchantments.LUCK);
        addEnchantmentToTag("apothic_enchanting:icy_thorns", ModTags.Enchantments.FREEZE);
        addEnchantmentToTag("apothic_enchanting:infusion", ModTags.Enchantments.COOLDOWN_REDUCE);
        addEnchantmentToTag("apothic_enchanting:knowledge_of_the_ages", ModTags.Enchantments.LUCK);
        addEnchantmentToTag("apothic_enchanting:life_mending", ModTags.Enchantments.HEAL);
        addEnchantmentToTag("apothic_enchanting:miners_fervor", ModTags.Enchantments.LUCK);
        addEnchantmentToTag("apothic_enchanting:natures_blessing", ModTags.Enchantments.LUCK);
        addEnchantmentToTag("apothic_enchanting:obliteration", ModTags.Enchantments.WAND_THWACK);
        addEnchantmentToTag("apothic_enchanting:obliteration", ModTags.Enchantments.TOME_AOE);
        addEnchantmentToTag("apothic_enchanting:rebounding", ModTags.Enchantments.KNOCKBACK);
        addEnchantmentToTag("apothic_enchanting:reflective_defenses", ModTags.Enchantments.KNOCKBACK);
        addEnchantmentToTag("apothic_enchanting:scavenger", ModTags.Enchantments.LUCK);
        addEnchantmentToTag("apothic_enchanting:shield_bash", ModTags.Enchantments.KNOCKBACK);
        addEnchantmentToTag("apothic_enchanting:spearfishing", ModTags.Enchantments.WAND_RANGE);
        addEnchantmentToTag("apothic_enchanting:spearfishing", ModTags.Enchantments.TOME_DASH);
        addEnchantmentToTag("apothic_enchanting:splitting", ModTags.Enchantments.MULTISHOT);
        addEnchantmentToTag("apothic_enchanting:stable_footing", ModTags.Enchantments.LAUNCH);
        addEnchantmentToTag("apothic_enchanting:tempting", ModTags.Enchantments.LUCK);
    ...
    private void addEnchantmentToTag(String enchantmentId, TagKey<Enchantment> tag) {
        ...
        ResourceLocation enchantmentLoc = ResourceLocation.fromNamespaceAndPath(parts[0], parts[1]);
